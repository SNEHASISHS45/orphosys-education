...
async function GET(req) {
    ...
    try {
        if (page && section) {
            const entry = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].pageSection.findUnique({
                where: {
                    page_section: {
                        page,
                        section
        ...
        const sections = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].pageSection.findMany();
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(sections);
    } catch (error) {
...
async function POST(req) {
    ...
    try {
        ...
        const entry = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].pageSection.upsert({
            where: {
                page_section: {
                    page,
                    section
...
//# sourceMappingURL=app_api_sections_route_ts_c23d766a._.js.map