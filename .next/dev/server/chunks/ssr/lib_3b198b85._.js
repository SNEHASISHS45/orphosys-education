...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$client$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/generated/client/index.js [app-rsc] (ecmascript)");
...
const prismaClientSingleton = ()=>{
    ...
    return new __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$generated$2f$client$2f$index$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["PrismaClient"]({
        adapter: adapter,
        log: [
            "query"
        ]
...
const prisma = globalThis.prisma && globalThis.prisma.program ? globalThis.prisma : prismaClientSingleton();
...
async function getGlobalSettings() {
    try {
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].globalSettings.findUnique({
            where: {
                id: "singleton"
            }
        });
...
async function getPageSection(page, section) {
    try {
        const data = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].pageSection.findUnique({
            where: {
                page_section: {
                    page,
                    section
...
async function getCourses() {
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].course.findMany({
            where: {
                isActive: true
            },
            orderBy: {
...
async function getTeamMembers() {
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].teamMember.findMany({
            orderBy: {
                order: "asc"
            }
        });
...
async function getPartners() {
    try {
        return await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].partner.findMany({
            orderBy: {
                order: "asc"
            }
        });
...
//# sourceMappingURL=lib_3b198b85._.js.map