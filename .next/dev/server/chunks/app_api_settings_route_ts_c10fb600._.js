...
async function GET() {
    try {
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].globalSettings.findUnique({
            where: {
                id: "singleton"
            }
        });
...
async function POST(req) {
    ...
    try {
        ...
        const settings = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["prisma"].globalSettings.upsert({
            where: {
                id: "singleton"
            },
            update: body,
...
//# sourceMappingURL=app_api_settings_route_ts_c10fb600._.js.map